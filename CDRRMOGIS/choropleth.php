...
<head>
    ...
    <title>Choropleth Map | City Disaster Risk Management</title>    
...
<script>
    ...
    var map = L.map('map').setView([10.719950067615137, 122.554175308317468], 12);
...
function highlightFeature(e) {
    ...
    info.update = function (props) {
        ...
        '   <option>House Distribution</option>'+
        '   <option>Common Disaster Per Barangay</option>'+
        '   <option>Choose a Demographic Value</option>'+
        '   </select>';
    };
