    ...
    <div id="pagemessagebox" tabindex="0"></div>
            ...
            <div class="list-group">
                <div class="row">
                    <?php
                    $brgylist = array();
                    $sql = "SELECT barangay.ID, barangay.NAME FROM barangay, disaster_declare WHERE disaster_declare.BRGY = barangay.ID GROUP BY barangay.ID";
                        ...
                        if($count > 0) {
                            ...
                            <div class="col-lg-6">
                                <div class="media dashboard_item">
                                    <a href="CswdOnGoingDisasterListofBrgy.php?id=<?php echo $brgy[0]; ?>"
                                       class="thumbnail">
