...
<div class="container"> <!--Content starts here-->
    <div class="page-header">
        ...
        <span class = "pull-right">
            <div class="btn-group"><button id="Barangay_BTN_' + id + '" value="' + id + '" class="btn btn-basic" data-toggle="modal" data-target="#UpdateBarangayModal" onclick="location.href='disasterArchive.php'"><span class="glyphicon glyphicon-menu-left"></span> Return to Manage Disaster Archive</button><input type="hidden" class="btn" /></div>
        </span>
        <small> <br /><?php echo $group_name; ?></small>
        </h2>
    </div>
