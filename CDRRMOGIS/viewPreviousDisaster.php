...
<div class="container"> <!--Content starts here-->
    <div class="page-header">
        <h3>
            View Confirmed Disaster Profile
        <span class = "pull-right">
            <div class="btn-group"><button id="Barangay_BTN_' + id + '" value="' + id + '" class="btn btn-secondary" data-toggle="modal" data-target="#UpdateBarangayModal" onclick="location.href='managedisasterprofilenew.php'"><span class="glyphicon glyphicon-menu-right"></span> Manage Disaster Archive</button><input type="hidden" class="btn" /></div>
        </span>
        </h3>
    </div>
    <div class="container">
                    ...
                    foreach ($OnGoingDisasters as $disaster){
                        ?>
                            <tr>
                                ...
                                <td><a href="viewDisasterDetails.php?id=<?php echo $disaster['ID']; ?>" class="btn btn-primary">View More Details</a></td>
                            </tr>
                        <?php
                    }
                ?>
