...
<div class="modal fade" id="DisasterReportModal" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="DisasterReportForm" method="post" action="library/form/CswdDisasterReportFormtest.php">
                <div class="modal-body">
                      ...
                      <!--    <input type="text" value="cswd" id = "disasterReportForm_REPORTID" name="REPORTID" style="display: none;" /> -->
                        ...
                        <div class="panel-body">
                            <div class="input-group input-group">
                              ...
                              <input type="text" value="cswd" id = "disasterReportForm_REPORTID" name="REPORTID" />
