...
<head>
    ...
    <title>Assign Map | City Disaster Risk Management</title>    
...
<?php include('library/html/navbar.php');
   ...
   <div class="container">
    <div class="page-header">
        <button class="btn btn-basic pull-right dbSync" data-toggle="modal" >
             Assign Map
        </button>
        <h3>Assign Map <small> for Barangay Montinola</small></h3>
    </div>
...
function highlightFeature(e) {
    ...
    info.update = function (props) {
        this._div.innerHTML = '<h4>Population Density of Iloilo City</h4>' +  (props ?
            '<b>' + props.NAME_3 + '</b>'
            : 'Hover over a state');
    };
