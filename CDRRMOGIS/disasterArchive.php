...
<div class="modal fade" id="AddGroupModal" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="AddDisasterNameForm" method="post" action="library/form/newArchiveForm.php">
...
<div class="container"> <!--Content starts here-->
    <div class="page-header">
        <h2>Manage Disaster Archive
        <span class = "pull-right">
            <div class="btn-group"><button id="Barangay_BTN_' + id + '" value="' + id + '" class="btn btn-basic" data-toggle="modal" data-target="#AddGroupModal" onclick=""><span class="glyphicon glyphicon-plus"></span> Add New Disaster Archive</button><input type="hidden" class="btn" /></div>
        </span>
        </h2>
        <p><i> manages all disaster profile in for public viewing </i></p>
    </div>
...
<script>
    ...
    function AddNewGroupName(id, type, name, date, count) {
        ...
        '<a href="disasterArchiveView.php?id=' + id + '" class="list-group-item">' +
        '   <h3>[' + type + '] ' + name + '</h3>' +
