...
<?php
    ...
    if(isset($_GET["id"])){
        ...
        $sql = "SELECT disaster_typhoonprofile.*
                ...
                WHERE disaster_typhoonprofile.ID = " . $group_id . "
        ...
        while($row = $result->fetch_assoc()){
            ...
            $group_signalno = $row['SIGNALNO'];
            $group_windspeed = $row['WINDSPEED'];
        }
    }
    else{
        PageNotAvailable();
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Edit Typhoon Profile</h4>
            </div>
            <form id="EditNameForm" method="post" action="library/form/CdrrmoEditTyphoonProfile.php">
                    ...
                    <br />
                       <div class="input-group">
                        <span class="input-group-addon">Signal No.</span>
                         <input type="number" name="signalno" class="form-control" max = "5" min = "1" value="<?php echo $group_signalno; ?>" />
                    </div>
                    <br />
                    <div class="input-group">
                        <span class="input-group-addon">Highest windspeed</span>
                         <input type="number" name="windspeed" class="form-control" value="<?php echo $group_windspeed; ?>" required />
                    </div>
                    <br />
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="SearchForm" method="get" action="library/form/CdrrmoSearchTyphoonProfile.php">
...
<div class="modal fade" id="DeleteNameModal" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="DeleteNameForm" method="post" action="library/form/CdrrmoDeleteTyphoonProfile.php">
                <div class="modal-body">
                    <div id="DeleteNameForm_msgbox" tabindex="0"></div>
                    <input type="text" name="id" style="display: none;" value="<?php echo $group_id; ?>" />
                    <p>
                        Do you want to delete this Typhoon Profile?
                    </p>
                </div>
                <div class="modal-footer">
...
<div class="container"> <!--Content starts here-->
    <div class="page-header">
        <h1>Disaster Profile Manage View<small><br />Manage Profile for "<?php echo $group_name; ?>"</small></h1>
    </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <table class="table">
                    ...
                    <tr>
                        <td>Signal No: </td>
                        <td><?php echo $group_signalno; ?></td>
                    </tr>
                    <tr>
                        <td>Maximum wind speed: </td>
                        <td><?php echo $group_windspeed; ?></td>
                    </tr>
                    <tr>
                        <td>Date Started: </td>
...
<div style="display: none;">
    <form id="AddForm" method="post" action="library/form/CdrrmoAddTyphoonList.php">
        <input id="AddIdInput" type="text" name="id" />
        <input type="text" name="groupid" value="<?php echo $group_id; ?>" />
    </form>

    <form id="DeleteForm" method="post" action="library/form/CdrrmoRemoveFromTyphoonList.php">
        ...
        $(this).ajaxSubmit({
            ...
            success:function(data)
            {
                ...
                DisplayMsg(data, 'DeleteNameForm_msgbox', function (SuccessMsg) {
                    ...
                    window.location = 'CdrrmoManageTyphoonProfile.php';
                });
            }
        });
    };
...
<script type="text/jsx">
    ...
    $sql = "SELECT 	disaster_declare.ID,
                                ...
                                FROM 	disaster_declare, disaster_type, barangay, disaster_typhoonlist
                                
                                WHERE 	disaster_declare.BRGY = barangay.ID
                                AND		disaster_declare.DISASTER = disaster_type.ID
                                AND		disaster_declare.ID = disaster_typhoonlist.DECLAREID
                                AND		disaster_typhoonlist.PROFILEID = " . $group_id . "
                ...
                <div className="col-lg-6">
                    <div className="thumbnail">
                        <div className="list-group-item">
                            ...
                            <p className="list-group-item-text">Type: {this.props.DISASTER}</p>
                            <p className="list-group-item-text">Started: {this.props.STARTED}</p>
                            <a href="CdrrmoViewDisasterDetails.php?id=(\'' + {this.props.DISASTERID} + '\')" class="btn btn-primary">View More Details</a>
